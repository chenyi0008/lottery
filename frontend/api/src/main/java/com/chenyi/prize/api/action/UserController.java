...
import com.chenyi.prize.commons.db.entity.CardUserDto;
import com.chenyi.prize.commons.db.entity.ViewCardUserHit;
import com.chenyi.prize.commons.db.service.GameLoadService;
import com.chenyi.prize.commons.db.service.ViewCardUserHitService;
...
public class UserController {
    ...
    public ApiResult hit(@PathVariable int gameid,@PathVariable int curpage,@PathVariable int limit,HttpServletRequest request) {
        ...
        lqw.eq(ViewCardUserHit::getUserid, user.getId());
